  ...
  public function register_post_type_lsb_book() {
    register_post_type('lsb_book',
      array(
        ...
        'map_meta_cap' => true,
        'hierarchical' => false,
        'rewrite' => array('slug' => _x('bok', 'Bok-slug', 'lsb_boksok'), 'with_front' => 1),
        'query_var' => true,
        'has_archive' => true,
        'menu_position' => '5',
        ...
        'labels' => array (
          ...
          'not_found_in_trash' => __('Fant ingen bøker i papirkurven'),
          'parent'        => __('Forelderbok'),
        )
      )
    );
  }
  ...
  public function register_tax_lsb_author() {
    register_taxonomy( 'lsb_tax_author',
      ...
      array( 'hierarchical' => false,
      	...
      	'show_ui' => true,
      	'query_var' => true,
      	'rewrite' => array( 'slug' => _x('forfatter', 'Forfatter-slug', 'lsb_boksok') ),
